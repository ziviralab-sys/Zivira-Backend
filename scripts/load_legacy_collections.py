...
EMPLOYEES = [
    ...
    dict(employeeCode="EMP-MR-0004", name="Divya Menon", designation="Medical Representative", division="Ara",
    ...
    dict(employeeCode="EMP-MR-0006", name="Arjun Reddy", designation="Medical Representative", division="Ara",
...
EXPENSE_REPORTS = [
    ...
    dict(monthly="January 2026", team="Ara Field Team", budget=180000),
