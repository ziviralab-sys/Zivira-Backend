...
export const MASTERS: MasterConfig[] = [
  {
    ...
    fields: [
      ...
      { key: "divisionName", label: "Division Name", options: ["Astra", "Ara", "Zivira"] },
      { key: "divisionShortName", label: "Division Short Name", options: ["AST", "ARA", "ZIV"] },
  ...
  },
  {
    ...
    fields: [
      { key: "doctorCode", label: "Doctor Code", sourceMaster: "doctorMaster", sourceField: "doctorCode" },
      { key: "doctorName", label: "Doctor Name", computed: { fromField: "doctorCode", sourceMaster: "doctorMaster", lookupField: "doctorCode", displayField: "doctorName" } },
      { key: "doctorCategory", label: "Doctor Category (A/B/C)", options: ["A", "B", "C", "D"] },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "team", label: "Team", options: ["Zivira Field Team", "Astra Field Team", "Ara Field Team", "South Zone Managers"] },
